            ...
            <div class="card" style="height: 121px; border: 1px solid #D9D9D9; border-radius: 12px;">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <button class="btn btn-primary px-3 me-2" onclick="window.renderPage('income-edit', ${cat.id})">Редактировать</button>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-2 row-cols-xl-3 row-cols-xxl-3 g-3 mt-4" style="margin-bottom: 173px;">
            ...
            <div class="col">
                <div class="card p-3 d-flex align-items-center justify-content-center" style="height: 121px; border: 1px solid #D9D9D9; border-radius: 12px;">
                    <a href="javascript:void(0)" onclick="window.renderPage('income-create')" style="font-size: 36px; color: #D9D9D9; text-decoration: none;">+</a>
                </div>
            </div>
        </div>
    `;
...
function getExpenseCategoriesTemplate(categories) {
        ...
        <div class="col">
            <div class="card" style="height: 121px; border: 1px solid #D9D9D9; border-radius: 12px;">
                <div class="card-body">
                    <h5 class="card-title fs-3" style="color: #052C65;">${cat.title}</h5>
                    <div class="d-flex gap-2 mt-3">
                        <button class="btn btn-primary px-3 me-2" onclick="window.renderPage('expense-edit', ${cat.id})">Редактировать</button>
    ...
    return `
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-2 row-cols-xl-3 row-cols-xxl-3 g-3 mt-4" style="margin-bottom: 173px;">
            ...
            <div class="col">
                <div class="card p-3 d-flex align-items-center justify-content-center" style="height: 121px; border: 1px solid #D9D9D9; border-radius: 12px;">
                    <a href="javascript:void(0)" onclick="window.renderPage('expense-create')" style="font-size: 36px; color: #D9D9D9; text-decoration: none;">+</a>
                </div>
            </div>
        </div>
    `;
    ...
    const rowsHtml = operations.map(
        op => `
			<tr style="border-bottom: 1px solid #D9D9D9;">
				...
				<td>${op.comment || ''}</td>
				<td class="text-end">
					<a href="javascript:void(0)" onclick="window.window.editOperation(${op.id})" class="me-3"
    ...
    return `
        ...
        <div class="mt-5" style="max-width: 400px;">
            <div class="d-flex gap-3">
                <button class="btn btn-success px-3" onclick="window.renderPage('operation-create', 'income')">Создать доход</button>
                <button class="btn btn-danger px-3" onclick="window.renderPage('operation-create', 'expense')">Создать расход</button>
            </div>
        </div>
...
addRoute('income-create', `
    ...
    <div class="mt-5" style="max-width: 400px;">
        ...
        <div class="d-flex gap-3">
            ...
            <button class="btn btn-danger px-3" onclick="window.renderPage('income-categories')">Отмена</button>
        </div>
    </div>
`);
...
addRoute('expense-create', `
    ...
    <div class="mt-5" style="max-width: 400px;">
        ...
        <div class="d-flex gap-3">
            ...
            <button class="btn btn-danger px-3" onclick="window.renderPage('expense-categories')">Отмена</button>
        </div>
    </div>
`);
    ...
    return `
        ...
        <div class="mt-5" style="max-width: 400px;">
            ...
            <div class="d-flex gap-3">
                ...
                <button class="btn btn-danger px-3" onclick="window.renderPage('income-expense')">Отмена</button>
            </div>
        </div>
    `;
}
